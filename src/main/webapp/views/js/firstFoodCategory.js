...
function upStatus(statusName){
	...
	ids = ids.join(",");
	$.messager.confirm('确认','确定'+statusName+'食材名为[ '+names+' ]吗？',function(r){
		if(r){
			var data = {"ids":ids,"type":type,"rank":"One"};
			var url = dataOptions.baseUrl+'upCategoryStatus.htm';
...
var saveFirstCategory = function(){
	var url = dataOptions.baseUrl+'saveFirstCategory.htm';/* 配置保存数据地址 */
