...
<% 
	...
	String thisPath = basePath + "/foodcategory/";	
%>
...
<div id="gridTools" data-options="border:false" style="padding-top: 10px;">
	...
	<table id="mygrid" style="margin-top: 10px;display: none;" class="myResize"
	      data-options="url:'<%=thisPath %>getSecondCategoryList.htm',loadFilter:loadFilter,pageNumber:1,
	    ...
	    <thead>
	        <tr>
		        ...
		        <th data-options="field:'firstName',width:8,align:'center'">食材一级分类</th>
		        <th data-options="field:'name',width:8,align:'center'">食材二级分类</th>
	        	<th data-options="field:'logoPath',width:10,align:'center',formatter:imageFormatter">二级分类缩略图</th>
...
<div id="add-dialog" style="width: 500px;height: 400px;" class="easyui-dialog" class="easyui-dialog"  data-options="iconCls:'icon-save',resizable:true,modal:true,closed:true,title:'添加',buttons:[{text:'保存', iconCls:'icon-ok', handler:saveTowCategory},{text:'取消',iconCls:'icon-remove',handler:function(){$('#add-dialog').dialog('close');}}]">
	...
	<table class="mf-table">
		<tr class="mf-line">
			<td class="mf-left">食材一级分类：</td>
			<td class="mf-right">
				<input type="text" name="pid" style="width: 280px" class="easyui-combobox" data-options="valueField:'id',textField:'name',url:'<%=thisPath %>getFirstCombox.htm',required:true"/>
			</td>
		</tr>
		<tr class="mf-line">
			<td class="mf-left">食材二级分类：</td>
			<td class="mf-right">
		...
		<tr class="mf-line">
			...
			<td class="mf-right">
				 <div id="imgdiv"><img id="imgShow" width="280" height="180" /></div>
...
<script type="text/javascript" src="<%=basePath%>/views/js/towFoodCategory.js"></script>
