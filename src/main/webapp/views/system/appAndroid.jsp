...
<% 
	...
	String thisPath = basePath + "/appAndroid/";	
%>
<jsp:include page="../include.jsp"></jsp:include>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<script src="<%=basePath%>/js/uploadPreview/uploadPreview.js"
...
<body>
	...
	<div id="gridTools" data-options="border:false"
		...
		<form id="search-form" style="margin-left: 10px;">
			...
			版本名称：<input class="easyui-textBox" type="text" name="versionName" style="width: 150px" />&nbsp;&nbsp;&nbsp;&nbsp; 
	...
	<table id="mygrid" style="margin-top: 10px; display: none; width: 100%" class="myResize" data-options="url:'<%=thisPath %>getAppAndroidList.htm',loadFilter:loadFilter,
	      fitColumns:true,animate: true,showFooter: false,onLoadSuccess:gridLoadSuccess,pagination:true,loading:true,rownumbers:true">
		<thead>
			<tr>
				<th data-options="field:'ck',checkbox:true"></th>
				<th data-options="field:'name',width:10,align:'center'">应用名称</th>
				<th data-options="field:'versionName',width:10,align:'center'">版本名称</th>
				...
				<th data-options="field:'remark',width:10,align:'center'">描述</th>
				<th data-options="field:'updatePersonnel',width:10,align:'center'">更新人员</th>
				<th data-options="field:'downloadCount',width:10,align:'center'">下载次数</th>
	...
	<div style="display: none;">
		...
		<div id="add-dialog" style="width: 600px; height: 500px;"
			class="easyui-dialog" class="easyui-dialog"
			data-options="iconCls:'icon-save',resizable:true,modal:true,closed:true,title:'添加',buttons:[{text:'保存', iconCls:'icon-ok', handler:saveUser},{text:'取消',iconCls:'icon-remove',handler:function(){$('#add-dialog').dialog('close');}}]">
			<form id="add-data-form" enctype="multipart/form-data"
				target="uploadImgFrame" method="post"
				style="margin: 0px; padding: 0px;">
				<input type="hidden" name="id" />
				<table class="mf-table">
					<tr class="mf-line">
						<td class="mf-left">应用名称：</td>
						<td class="mf-right"><input type="text" name="name"
							style="width: 250px" data-options="required:true" /></td>
					</tr>
					<tr class="mf-line">
						<td class="mf-left">版本名称：</td>
						<td class="mf-right"><input type="text" name="versionName"
					...
					<tr class="mf-line">
						...
						<td class="mf-right"><input type="text" name="versionCode"
							...
							<span style="color: blue; font-size: 10">请输入输入8位数字，如：20180420</span>
						</td>
					</tr>
					<tr class="mf-line">
						<td class="mf-left">应用文件：</td>
						<td class="mf-right">
					...
					<tr class="mf-line">
						<td class="mf-left">描述：</td>
						<td class="mf-right" colspan="3"><textarea type="text"
								name="remark" style="width: 100%; height: 80px"
								data-options="required:false" class="easyui-validatebox"></textarea>
								<span style="color: blue; font-size: 10"> 分段陈述请以“；”隔开，便于app端页面展示</span>
						</td>
					</tr>
				</table>
			</form>
	...
	<script type="text/javascript"
		src="<%=basePath%>/views/js/appAndroid.js"></script>
	<script type="text/javascript">
	$(function(){
