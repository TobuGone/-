...
<% 
	...
	String thisPath = basePath + "/connect/";	
%>
...
<div id="gridTools" data-options="border:false" style="padding-top: 10px;">
	...
	<table id="mygrid" style="margin-top: 10px;display: none;" class="myResize"
	      data-options="url:'<%=thisPath %>getConnectList.htm',loadFilter:loadFilter,
...
<div id="add-dialog" style="width: 550px;height: 420px;" class="easyui-dialog" class="easyui-dialog"  data-options="iconCls:'icon-save',resizable:true,modal:true,closed:true,title:'添加',buttons:[{text:'保存', iconCls:'icon-ok', handler:saveConnect},{text:'取消',iconCls:'icon-remove',handler:function(){$('#add-dialog').dialog('close');}}]">
	...
	<table class="mf-table">
		<tr class="mf-line">
			...
			<td class="mf-right" colspan="3">
				 <div id="imgdiv"><img id="imgShow" width="350" height="250" /></div>
...
<script type="text/javascript" src="<%=basePath%>/views/js/connectGuide.js"></script>
