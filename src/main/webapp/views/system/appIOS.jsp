...
<% 
	...
	String thisPath = basePath + "/appIOS/";	
%>
...
<body>
	...
	<table id="mygrid" style="margin-top: 10px; display: none; width: 100%" class="myResize" data-options="url:'<%=thisPath %>getAppIOSList.htm',loadFilter:loadFilter,
				...
				<table class="mf-table">
					...
					<tr class="mf-line">
						...
						<td class="mf-right"><input type="text" name="versionCode"
							...
							<span style="color: gray; font-size: 10">请输入输入8位数字，如：20180420</span>
						</td>
					</tr>
					<tr class="mf-line">
					...
					<tr class="mf-line">
						...
						<td class="mf-right" colspan="3"><textarea type="text"
								...
								<span style="color: gray; font-size: 10"> 分段陈述请以“；”隔开，便于app端页面展示</span>
						</td>
					</tr>
				</table>
			</form>
	...
	<script type="text/javascript"
		src="<%=basePath%>/views/js/appIOS.js"></script>
	<script type="text/javascript">
	$(function(){
