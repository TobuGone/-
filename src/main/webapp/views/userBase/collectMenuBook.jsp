...
<div id="gridTools" data-options="border:false" style="padding-top: 10px;">
	<form id="search-form" style="margin-left: 10px;">
	          收藏用户昵称：<input class="easyui-textBox" type="text" name="searchNickName" style="width: 150px"/>&nbsp;&nbsp;&nbsp;&nbsp;    
	...
	<table id="mygrid" style="margin-top: 10px;display: none;" class="myResize"
	      data-options="url:'<%=thisPath %>getCollectList.htm',loadFilter:loadFilter,
	      fitColumns:true,animate: true,showFooter: false,onLoadSuccess:gridLoadSuccess,pagination:true,loading:true,rownumbers:true">
	    <thead>
	        <tr>
	        	<th data-options="field:'ck',checkbox:true"></th>
		        <th data-options="field:'collectNickName',width:5,align:'center'">收藏用户昵称</th>
		        <th data-options="field:'nickName',width:5,align:'center'">菜谱的用户昵称</th>
		        ...
		        <th data-options="field:'menuProcedure',width:8,align:'center'">步骤</th>
		         <th data-options="field:'click_number',width:4,align:'center'">点击量</th>
	        	<th data-options="field:'createTime',width:6,align:'center'">收藏时间</th>
...
<script type="text/javascript" src="<%=basePath%>/views/js/collectMenuBook.js"></script>
