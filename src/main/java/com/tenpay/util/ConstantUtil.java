...
public class ConstantUtil {
	...
	//初始化
	public static String APP_ID = "wxc8d23568b32694e4";//微信开发平台应用id
	public static String APP_SECRET = "a885fab32d45d26263605726e9a77f6c";//应用对应的凭证
	//应用对应的密钥
	...
	public static String PARTNER = "1242067302";//财付通商户号
	public static String PARTNER_KEY = "meirongjiemeirongjiemeirongjie33";//商户号对应的密钥
